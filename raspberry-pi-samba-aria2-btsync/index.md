...
主要用来查看树莓派派的各项参数。
按照[树莓派实验室官方教程](https://make.quwj.com/project/10) 操作即可，无坑。

弄完之后，发现SWAP占用量100%，空间也只有100M，就查了一下：

通过树莓派实验室的[修改树莓派交换分区 SWAP 的正确姿势](https://shumeipai.nxez.com/2017/12/18/how-to-modify-raspberry-pi-swap-partition.html)解决了，该文提到的[原文](http://www.bitpi.co/2015/02/11/how-to-change-raspberry-pis-swapfile-size-on-rasbian/)提到：一般的经验法则是交换文件的大小应该是机器上可用RAM的**两倍**左右。
...
主要用来过滤广告，感觉效果PC端不如插件。
直接看[官方wiki](https://github.com/AdguardTeam/AdGuardHome/wiki/Raspberry-Pi)，照着做即可，不过有可能wget失败，那只能八仙过海了。

安装完，设置参考[少数派](https://sspai.com/post/63088)
